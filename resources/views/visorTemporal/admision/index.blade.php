...
@section('main_temporal')
    ...
    <body>
        ...
        <header>
            <div>
                <h1>Panel de Gestión Operativa - admisión</h1>
                <span style="color:var(--sub); font-size: 13px;">CEO Salud · Especialidades</span>
            </div>
            <div class="user-selector">
                <label for="currentUser">Usuario: recepcionuno</label>
                <a href="{{ route('admision.temporal.index') }}" class="btn-sm btn-success">🔄 Actualizar</a>
            </div>
        </header>
        ...
        <div class="grid" id="container">
            ...
            @foreach ($appointments as $appointment)
                <div class="card">
                    <div>
                        <span style="font-size:20px; font-weight:bold;"> #{{ $appointment->id }}
                        </span>
